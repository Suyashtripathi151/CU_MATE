...
public class MyItem extends AppCompatActivity {
    ...
    ImageButton menu,notification;

    String userID,currentUser,ui,cu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lost=findViewById(R.id.mybtnsubmit);

        menu=findViewById(R.id.mymenubtn2);
        notification=findViewById(R.id.mybtnnotific);

        welcome=findViewById(R.id.mytextViewwelome2);
        profilepic=findViewById(R.id.myimgprofilepic2);
        ...
        getuserid();
        if(!String.valueOf(ui).isEmpty()){
            FirebaseRecyclerOptions<foundmodel> options = new FirebaseRecyclerOptions.Builder<foundmodel>()
                    .setQuery(FirebaseDatabase.getInstance().getReference().child("userdata").child(ui).child("myitem"), foundmodel.class)
                    .build();
        ...
        lost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(MyItem.this,LostActivity.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MyItem.this,MyItem.class);
                startActivity(intent);
            }
        });
    ...
    private void showmenu(View v) {
        PopupMenu popupMenu = new PopupMenu(MyItem.this, v);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == R.id.resetpassword) {
                    Intent intent=new Intent(MyItem.this,ForgotActivity.class);
                    startActivity(intent);
    ...
    private void deleteAccount() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MyItem.this);
                ...
                user.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(MyItem.this, "Account Deleted Successfully", Toast.LENGTH_SHORT).show();
                            Intent intent=new Intent(MyItem.this,MainActivity.class);
                            startActivity(intent);

                        }
                        else {
                            Toast.makeText(MyItem.this,task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
            ...
            public void onClick(View v) {
                if(!confirmation.isChecked()){
                    ...
                    dbbug.child(key).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(MyItem.this, "Bug Reported Succesfully !", Toast.LENGTH_SHORT).show();
                                        alertDialogimage.dismiss();
                                    }

                                    else {
                                        Toast.makeText(MyItem.this, "Failed to Report Bug !"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        alertDialogimage.dismiss();
                                    }
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(MyItem.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    alertDialogimage.dismiss();
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Toast.makeText(MyItem.this, "USER ID NOT FOUND", Toast.LENGTH_SHORT).show();

                    }
                } else {
                    Toast.makeText(MyItem.this, "NOT SUCCESSFULL", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
